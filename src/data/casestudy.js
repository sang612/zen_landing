export const casestudyList = [
  {
    id: "1",
    imgSrc: "/casestudy/phone-tracker-number-locator/thumbnail.png",
    name: "Phone Tracker Number Locator App",
    badge: ["Flutter", "App"],
    detail: {
      title: "Phone Tracker Number Locator App",
  ...
  {
    id: "2",
    imgSrc: "/casestudy/fam/thumbnail.png",
    name: "Fam: Location Sharing App",
    badge: ["React Native", "App"],
    detail: {
      title: "Fam: Location Sharing App",
      ...
      label2: "Download",
      content2: "http://surl.li/iepzw",
      image: ["/casestudy/fam/2.png", "/casestudy/fam/1.png"],
      qr: "/casestudy/fam/qr.png",
    },
    category: "app",
  },
  {
    id: "3",
    imgSrc: "/casestudy/gigapp/thumbnail.png",
    name: "GigApp",
    badge: ["React Native | ReactJS | Flutter | API: GraphQL", "App"],
    detail: {
      title: "GigApp",
      ...
      image: ["/casestudy/gigapp/1.png", "/casestudy/gigapp/2.png"],
    },
    category: "app",
  },
  {
    id: "4",
    imgSrc: "/casestudy/giole/thumbnail.png",
    name: "GIOLE App",
    badge: ["Flutter", "App"],
    detail: {
      title: "GIOLE App",
      ...
      content2: [
        {
          id: "1",
          text: "Vatican News (vaticannews.va):",
          link: "http://surl.li/ihcqk",
        },
        {
          id: "2",
          text: "Catholic Bishops’ Conference of Vietnam (hdgmvietnam.com):",
          link: "fhttp://surl.li/ihcqp",
        },
      ],
      image: ["/casestudy/giole/1.png", "/casestudy/giole/2.png"],
      label3: "Download",
      qr: "/casestudy/giole/qr.png",
      qr2: "/casestudy/giole/qr2.png",
      link1: "http://surl.li/ieqeq",
      link2: "http://surl.li/ieqoh",
      isAppleStore: true,
      isQRRight: true,
    },
    category: "app",
  ...
  {
    id: "5",
    imgSrc: "/casestudy/pcr-test-kit/thumbnail.png",
    name: "PCR Test Kit App",
    badge: ["React Native | ReactJS | API:GraphQL", "App"],
    detail: {
      title: "PCR Test Kit App",
      ...
      image: ["/casestudy/pcr-test-kit/1.png", "/casestudy/pcr-test-kit/2.png"],
    },
    category: "app",
  },
  {
    ...
    name: "JMatch (Jマッチ) Website",
    badge: ["PHP - Laravel", "Web"],
    detail: {
      title: "JMatch (Jマッチ) Website",
  ...
  {
    id: "7",
    imgSrc: "/casestudy/video-to-mp3-converter/thumbnail.png",
    name: "Video To Mp3 Converter App",
    badge: ["Flutter", "App"],
    detail: {
      title: "Video To Mp3 Converter App",
      ...
      label2: "Download",
      content2: "http://surl.li/ieqqc",
      image: [
        "/casestudy/video-to-mp3-converter/1.png",
        "/casestudy/video-to-mp3-converter/2.png",
      ],
      qr: "/casestudy/video-to-mp3-converter/qr.png",
    },
    category: "app",
  },
  {
    id: "8",
    imgSrc: "/casestudy/waocon/thumbnail.png",
    name: "Video Editing with Interactive Elements Website",
    badge: ["PHP - Laravel | ReactJS - Javascript", "Web"],
    detail: {
      title: "Video Editing with Interactive Elements Website",
      ...
      content: [
        ...
        {
          id: "2",
          text: "ReactJS - Javascript",
        },
      ],
      label2: "Website",
      content2: "https://waocon.com/shibuya-jct/",
      image: ["/casestudy/waocon/1.png"],
    },
    category: "web",
  },
  {
    id: "9",
    imgSrc: "/casestudy/4ekid/thumbnail.png",
    name: "4E Kids App",
    badge: ["React Native | NodeJS | Blockchain", "App | Blockchain"],
    detail: {
      title: "4E Kids App",
      ...
      image: ["/casestudy/4ekid/1.png", "/casestudy/4ekid/2.png"],
      qr: "/casestudy/4ekid/qr.png",
    ...
    category: ["app", "blockchain"],
  },
  {
    id: "10",
    imgSrc: "/casestudy/4ehub/thumbnail.png",
    name: "4E Hub App",
    badge: ["React Native | NodeJS | Blockchain", "App | Blockchain"],
    detail: {
      title: "4E Hub App",
      ...
      image: ["/casestudy/4ehub/1.png", "/casestudy/4ehub/2.png"],
      qr: "/casestudy/4ehub/qr.png",
  ...
  {
    id: "11",
    imgSrc: "/casestudy/corgiswap/thumbnail.png",
    name: "CorgiSwap Website",
    badge: [
      "React Native | ReactJS | TypeScript | Web3.js | Ethers.js",
      "Web | Blockchain",
    ],
    detail: {
      title: "CorgiSwap Website",
      ...
      content2: "https://corgiswap.org/",
      image: ["/casestudy/corgiswap/1.png"],
      label2: "Website",
      link: "https://corgiswap.org/",
    },
    category: ["web", "blockchain"],
  },
  {
    id: "12",
    imgSrc: "/casestudy/corgiwallet/thumbnail.png",
    name: "CorgiWallet App",
    badge: [
      "React Native | ReactJS | TypeScript | Web3.js | Ether.js",
      "App | Blockchain",
    ],
    detail: {
      title: "CorgiWallet App",
      ...
      image: ["/casestudy/corgiwallet/1.png", "/casestudy/corgiwallet/2.png"],
    },
    category: ["app", "blockchain"],
  },
  {
    id: "13",
    imgSrc: "/casestudy/corgisport/thumbnail.png",
    name: "CorgiSport App",
    badge: [
      "React Native | ReactJS | TypeScript | NodeJS | Web3.js | Solidity",
      "App | Blockchain",
    ],
    detail: {
      title: "CorgiSport App",
      ...
      image: ["/casestudy/corgisport/1.png", "/casestudy/corgisport/2.png"],
    },
    category: ["app", "blockchain"],
  },
  {
    id: "14",
    imgSrc: "/casestudy/athena/thumbnail.png",
    name: "AthenaAI Website",
    badge: ["PHP - Laravel | ChatGPT", "Web | AI"],
    detail: {
      title: "AthenaAI Website",
  ...
  },
  {
    ...
    name: "Nerusoku (寝るソク) App",
    badge: ["NextJS | NodeJS | AWS (S3)", "App | AI"],
    detail: {
      title: "Nerusoku (寝るソク) App",
  ...
  },
  {
    ...
    name: "AI Cartoon Face: Anime Filter App",
    badge: ["Flutter | Tensorflow", "App | AI"],
    detail: {
      title: "AI Cartoon Face: Anime Filter App",
  ...
  {
    id: "17",
    imgSrc: "/casestudy/uavflightlog/thumbnail.png",
    name: "UAV Flight Log – Manage Drone Flight History App",
    badge: ["Flutter | Firebase", "App"],
    detail: {
      title: "UAV Flight Log – Manage Drone Flight History App",
  ...
  {
    id: "18",
    imgSrc: "/casestudy/gojapan/thumbnail.png",
    name: "Go Japan partner Website",
    badge: ["PHP - Laravel", "Web"],
    detail: {
      title: "Go Japan partner Website",
      ...
      image: ["/casestudy/gojapan/1.png"],
    },
    category: "web",
  },
  {
    id: "19",
    imgSrc: "/casestudy/fence-workshop/thumbnail.png",
    name: "FenceWorkshop Website",
    badge: ["Wordpress", "Web"],
    detail: {
      title: "FenceWorkshop Website",
      ...
      image: ["/casestudy/fence-workshop/1.png"],
    },
    category: "web",
  },
  {
    ...
    name: "Bihada salon (美肌サロン) Website",
    badge: ["Wordpress", "Web"],
    detail: {
      title: "Bihada salon (美肌サロン) Website",
      ...
      image: ["/casestudy/bahada/1.png"],
      label2: "Website",
      content2: "https://bihada-salon.net/",
    },
    category: "web",
  },
  {
    ...
    name: "Vietnamese Community in Hiroshima Website",
    badge: ["Wordpress", "Web"],
    detail: {
      title: "Vietnamese Community in Hiroshima Website",
      desc: "This app provides users with a seamless experience for ordering food from restaurants and food vendors. Once an order is placed, the app facilitates easy pickup and delivery right to your door. With the real-time order tracking feature, you can also monitor the status of your delivery. Moreover, the app offers a wide range of payment methods catering to the preferences of users.",
      label: "Techniques:",
      content: [
        {
      ...
      image: ["/casestudy/hiroshima/1.png"],
    },
    category: "web",
  },
  {
    ...
    name: "Medical Note (診察ノオト) App",
    badge: ["React Native | ReactJS | Flutter | API:GraphQL", "App | AI"],
    detail: {
      title: "Medical Note (診察ノオト) App",
      ...
      image: ["/casestudy/nooto/1.png", "/casestudy/nooto/2.png"],
      label2: "Download",
  ...
  {
    id: "23",
    imgSrc: "/casestudy/sns/thumbnail.png",
    name: "SNS PDCA System Website",
    badge: ["PHP - Laravel | Flutter", "Web"],
    detail: {
      title: "SNS PDCA System Website",
